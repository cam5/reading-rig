...
// font instead of Figtree/Newsreader. `?url` gets Vite to resolve the same
...
// #89) to keep it from competing with Figtree/Newsreader for cold-load
...
for (const href of [figtreeLatin400Woff2, newsreaderLatin400Woff2, caprasimoSubsetWoff2]) {
