...
export const handleError: HandleErrorFunction = (error, { request }) => {
  ...
  requireUser()
    .then((user) => captureException(error, { distinctId: user.id, currentUrl: canonicalRequestUrl(request) }))
    .catch((requireUserError) => console.warn("[error-tracking] could not report exception:", requireUserError));
};
