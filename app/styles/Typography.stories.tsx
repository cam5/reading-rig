  ...
  render: () => (
    ...
    >
      ...
      <div>
        ...
        <p className="font-body text-sm">Ch. 1 · §4 · 9 min left in section</p>
      </div>
      ...
      <div>
        ...
        <p className="font-reading text-[17.5px] leading-[1.8]">
          ...
          forms of the materials furnished by Nature, in such a way as to make
          them useful to him. The form of wood, for instance, is altered, by
          making a table out of it. Yet, for all that, the table continues to be
          that common, every-day thing, wood.
        </p>
      </div>
    </div>
  ),
