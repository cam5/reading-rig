...
export async function consumeMagicLinkToken(
  ...
  // Atomically mark as consumed only if not already consumed
  ...
  if (updated.count > 0) {
    // Successfully consumed - fetch the record to get the email and check expiry
